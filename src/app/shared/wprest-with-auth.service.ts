...
export class WprestWithAuthService {
  ...
  createPost(){       
    ...
    // Send POST request
    return this.httpClient.post(ConstantGlobals.WP_API_BASE + '/wp/v2/persons',newPost);
  }
  ...
  updatePost(){       
    ...
    // Send POST request
    return this.httpClient.post(ConstantGlobals.WP_API_BASE + '/wp/v2/persons/5/',newPost);
  }
